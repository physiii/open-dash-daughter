...
#define GPIO_OUTPUT_PIN_SEL  ((1ULL<<MAIN_POWER_IO) | (1ULL<<DISPLAY_POWER_IO) | (1ULL<<AUDIO_STBY_IO) | (1ULL<<AUDIO_MUTE_IO))
#define GPIO_INPUT_PIN_SEL  (1ULL<<IGNITION_WIRE_IO)
